...
class DownloadCdnDataSourceImpl(
    ...
    override suspend fun downloadFile(downloadableCdn: DownloadableCdnDomainModel, path: String): Flow<DownloadState> =
        try {
    ...
    override suspend fun getPrivateFileLink(downloadableCdn: DownloadableCdnDomainModel.Private): Response<String> =
        executeRequest {
