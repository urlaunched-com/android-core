...
class DownloadCdnRepositoryImpl(private val cdnDataSource: DownloadCdnDataSource) : DownloadCdnRepository {
    override suspend fun downloadFile(downloadableCdn: DownloadableCdnDomainModel, path: String) = cdnDataSource.downloadFile(downloadableCdn, path)
